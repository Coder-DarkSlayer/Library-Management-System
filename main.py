    ...
    def createTab():
        while True:
            ...
            try:
                ...
                DATE_ADDED date not null,ENTRY_DATE datetime not null default now(),primary key(BOOK_ID),unique key(S_NO))""")
                ...
                ADDRESS varchar(200) not null,ENTRY_DATE datetime not null default now(),UNIQUE KEY(S_NO), PRIMARY KEY(USER_ID))''')
                ...
                DATE_GIVEN date,NOTIFIED tinyint not null default 0,UNIQUE KEY(S_NO),ENTRY_DATE datetime not null default now(),
            ...
            try:
                ...
                try:
                    ...
                    cursor.execute("""create table SUPERUSERS(
                            ...
                            LIBRARY_PASSWORD varchar(30) not null,DATE_ADDED datetime not null default CURRENT_TIMESTAMP,
